...
void LcdALL_Port(char a) {
    ...
    PORTBbits.RB2 = (a & 4) >> 2;
    PORTBbits.RB3 = (a & 8) >> 3;
    PORTBbits.RB4 = (a & 16) >> 4;
    PORTBbits.RB5 = (a & 32) >> 5;
    PORTBbits.RB6 = (a & 64) >> 6;
    PORTBbits.RB7 = (a & 128) >> 7;
}
...
char LcdALL_set_value(int byte_value){
    int centenas = (byte_value / 100 + 48);
    int decenas = ((byte_value%100)/10)+48;
    int unidades = (byte_value%10)+48;
